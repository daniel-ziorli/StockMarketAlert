...
def download_data(ticker):
    print (ticker)
    url = 'https://financialmodelingprep.com/api/v3/historical-price-full/%s?apikey=59fa8d8825c81ea3e22131b8c32a8cd1' % (ticker)
...
class html_email():
    ...
    def add_stock(self, ticker, time_frame=-1):
        ...
        data['200SMA'] = data['close'].rolling(window=int(c.get_setting('slow_sma'))).mean()
        data['20SMA'] = data['close'].rolling(window=int(c.get_setting('fast_sma'))).mean()
